...
public class RestaurantPostLikeDAO {
	...
	public boolean isLiked(int post_id, int member_id) {
		...
		String sql="select count(*) from restaurant_post_like "
	...
	public int insertLike(int post_id, int member_id) {
		...
		String sql="insert into restaurant_post_like(post_id, member_id) "
				  +"values(?, ?)";
	...
	public int deleteLike(int post_id, int member_id) {
		...
		String sql="delete from restaurant_post_like "
				  +"where post_id=? and member_id=?";
