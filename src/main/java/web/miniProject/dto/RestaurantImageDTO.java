...
public class RestaurantImageDTO {
	...
	public String getIs_thumbnail() {return is_thumbnail;}
	public void setIs_thumbnail(String is_thumbnail) {this.is_thumbnail=is_thumbnail;}
	
	public int getImage_order() {return image_order;}
	public void setImage_order(int image_order) {this.image_order=image_order;}
}
