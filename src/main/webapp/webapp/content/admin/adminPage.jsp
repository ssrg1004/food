       ...
       <div class="mypageContent">
            ...
            %>
                ...
                <table class="profileTable" style="text-align: center;">
                    <thead>
                        <tr>
                            <th style="text-align: center; font-weight: bold; width: 12%;">초안번호</th>
                            <th style="text-align: center; font-weight: bold; width: 47%;">제목</th>
            	...
            	<table class="profileTable" style="text-align: center;">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; font-weight: bold; width: 12%;">신고사유</th>
                            <th style="text-align: center; font-weight: bold; width: 35%;">신고된 댓글 내용</th>
                            <th style="text-align: center; font-weight: bold; width: 12%;">작성자</th>
