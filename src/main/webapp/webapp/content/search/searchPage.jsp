...
<div class="searchTab">
    ...
    <div class="resultSection">
        ...
        <div class="reviewList">
	        ...
	        %>
	        <a href="<%=request.getContextPath()%>/content/restaurant/resContent.jsp?post_id=<%=dto.getPost_id()%>" class="reviewCard">
                <img src="<%=request.getContextPath()%>/upload/review/<%=dto.getThumbnail()%>">
