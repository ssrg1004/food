...
<%
	MemberDTO myPost_sdto = (MemberDTO) session.getAttribute("loginUser");
	...
	ArrayList<MyPagePostDTO> list = dao.myReviewerPostList(myPost_sdto.getMember_id(), startRow, endRow);
	
	int count = dao.myReviewerPostCount(myPost_sdto.getMember_id()); //  총 작성 글 수
	System.out.println("memberId : "+myPost_sdto.getMember_id());
	System.out.println("start : "+startRow +" // end : "+endRow);
	System.out.println("listsize : "+list.size() + "// count : "+count);
